...
void AStairDismountCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AStairDismountCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AStairDismountCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AStairDismountCharacter::OnResetVR);
}


void AStairDismountCharacter::OnResetVR()
{
	// If StairDismount is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in StairDismount.Build.cs is not automatically propagated
...
void AStairDismountCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AStairDismountCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
